...
// The LCD menu string table (setup_0..setup_91) and its setup_str[] index
// lived here. The physical LCD menu is gone and the table had no remaining
// reader -- setup_str was defined and never referenced -- so 92 PROGMEM
// strings were sitting in flash describing programs that no longer exist.
